...
class EchoDataset(Dataset):
    ...
    def __init__(self, PatientStudy_list, TMED2SummaryTable, ML_DATA_dir, sampling_strategy='first_frame', training_seed=0, transform_fn=None):
        ...
        # NOTE: using the patient_id column in TMED2SummaryTable 
        # can uniquely identify a patient_study 
        # (there is NO same patient_study belong to 
        # different parts: diagnosis_labeled/, unlabeled/, view_and_diagnosis_labeled_set/, 
        # view_labeled AT THE SAME TIME)    
    ...
    def _create_bags(self):
        ...
        for study_idx, PatientStudy in enumerate(self.PatientStudy_list):
            ...
            if self.sampling_strategy == 'first_frame':
                ...
                #         
                # sample x times for this PatientStudy, resulting in x bag of 
                # correlated but not exactly the same bag of this PatientStudy
