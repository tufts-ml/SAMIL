...
export script="src.ABMIL.main"



#changeble setting from here:
# export model='gated_attention'
...
do
    ...
    export train_dir="$ROOT_DIR/experiments/ABMIL/Pretrained-$Pretrained/data_seed$data_seed/training_seed$training_seed/$development_size/"
